...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/02/22 16:57:09 by jamwang           #+#    #+#              #
#    Updated: 2019/02/27 15:02:34 by jamwang          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME=libft.a

SRCS=ft_atoi.c ft_bzero.c ft_strdup.c ft_isalnum.c \
     ...
     ft_strcpy.c ft_strdel.c ft_strequ.c ft_striter.c ft_striteri.c ft_strjoin.c \
	 ...
	 ft_lstiter.c ft_lstmap.c ft_printbits.c ft_strrev.c ft_swapbits.c \
	 ft_wordcount.c ft_swap.c
...
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o \
		...
		ft_lstmap.o ft_printbits.o ft_strrev.o ft_swapbits.o ft_wordcount.o ft_swap.o
